...
# Build & Install eap packages that contain container ACAPs.
```bash
...
docker pull axisecp/acap-runtime:aarch64-containerized
docker save axisecp/acap-runtime:aarch64-containerized -o runtime.tar
